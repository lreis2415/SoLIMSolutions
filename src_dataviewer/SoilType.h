...
public:
	...
	void getInferenceResult(float *resultBuf, CEnvDatabase *pEnvDatabase,bool bUseMask, bool *maskBuf, bool bCreateCheckFile,float *chkBuf,CProgressCtrl *ProgressBar,int iCurSoilID, int iSoilNum);
