...
class CErrorMatrixPntLabMapDlg : public CDialog
{
	DECLARE_DYNAMIC(CErrorMatrixPntLabMapDlg)

public:
	CErrorMatrixPntLabMapDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CErrorMatrixPntLabMapDlg();

// 对话框数据
	enum { IDD = IDD_ErrorMatrixPntLabMapDlg };
...
public:
	...
	afx_msg void OnBnClickedErrormatrixpntfilebtn();
	afx_msg void OnBnClickedErrormatrixlblfilebtn();
