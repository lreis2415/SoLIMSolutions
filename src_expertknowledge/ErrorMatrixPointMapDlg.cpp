...
*/
// ErrorMatrixPointMapDlg.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CErrorMatrixPointMapDlg, CDialog)
CErrorMatrixPointMapDlg::CErrorMatrixPointMapDlg(CWnd* pParent /*=NULL*/)
: CDialog(CErrorMatrixPointMapDlg::IDD, pParent)
{
	m_MatrixFileName = _T("");
...
CErrorMatrixPointMapDlg::~CErrorMatrixPointMapDlg()
{
}

void CErrorMatrixPointMapDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CErrorMatrixPointMapDlg, CDialog)
...
// CErrorMatrixPointMapDlg 消息处理程序

void CErrorMatrixPointMapDlg::OnBnClickedErrormatrixok()
{
	UpdateData(TRUE);
	...
	if ((fp=fopen(m_LookupFileName.GetBuffer(), "r"))==NULL) {
		MessageBox("Can't open look-up talbe");
		return;
	}
	...
	for (i=1; i<=numPoints; i++) {
		...
		for(int n=0;n<m;n++)
		{
			if(strcmp(soilName,LookupClasses[n].ClassLabel)==0) //find the soil type in look up table
			{
				found = 1;
				break;
			}
	...
	fprintf(fp, "The Error Matrix (%s vs %s)", 
		m_HardenedMapFileName.GetBuffer(), m_PointListFileName.GetBuffer());
...
void CErrorMatrixPointMapDlg::OnBnClickedObservedbtn()
{
	UpdateData(TRUE);	
...
void CErrorMatrixPointMapDlg::OnBnClickedLookuptablebtn()
{
	UpdateData(TRUE);	
...
void CErrorMatrixPointMapDlg::OnBnClickedErrormatrixhardenedmapbtn()
{
...
void CErrorMatrixPointMapDlg::OnBnClickedErrormatrixmatrixbtn()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);	
...
void CErrorMatrixPointMapDlg::OnBnClickedErrormatrixcancel()
{
	CDialog::OnCancel();
}

void CErrorMatrixPointMapDlg::CheckMask(bool* idBuf, int nrow, int ncol,CThreeDR *theData){ //Check if mask should be used
...
void CErrorMatrixPointMapDlg::OnMaskChk(){
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if(m_Mask){
...
void CErrorMatrixPointMapDlg::OnMaskFileBtn(){
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	static char BASED_CODE szFilter[] = "3dr Files (*.3dr)|*.3dr|All Files (*.*)|*.*||";
	CFileDialog m_ldFile(TRUE, NULL, "*.3dr", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, szFilter);
