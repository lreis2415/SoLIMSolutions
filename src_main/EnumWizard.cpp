...
void CEnumWizard::AddPage(CDialog* pDialog, UINT nID)
{
...
void CEnumWizard::OnPrev() 
{	
	/*if(nCurrentPage==3&&m_bAttachLayer==true)
	{
		nCurrentPage=1;
		ShowPage(1);
	}
...
void CEnumWizard::ShowPage(UINT nPos)
{
	struct PAGELINK* pTemp=pPageLink;
	while(pTemp)
	{
...
void CEnumWizard::SetWizButton(UINT uFlag)
{
