...
class CFreehandPage : public CDialog
{
	DECLARE_DYNAMIC(CFreehandPage)

public:
	CFreehandPage(CWnd* pParent = NULL);   // standard constructor
	virtual ~CFreehandPage();

	// Dialog Data
	enum { IDD = IDD_DIALOG_FREEHAND};
...
public:	
	...
	CStatic m_staticAddDelete;
	CStatic m_staticDrag;
	CStatic m_frameLocation;
...
public:
	...
	afx_msg void OnBnClickedButtonImportDm();
	CButton m_btnImportDM;
