...
void CInferenceView::OnSize(UINT nType, int cx, int cy)
{
	...
	{
		CRect rect(cx/10,7*cy/10+30,8*cx/10,7*cy/10+50);
	...
	{
		CRect rect(cx/10,8*cy/10,9*cx/10,9*cy/10);
		m_frameInferResult.MoveWindow(&rect);
	}

	if(m_staticResultDir.GetSafeHwnd())
	{
		CRect rect(1.5*cx/10,8.5*cy/10,3*cx/10,8.5*cy/10+20);
		m_staticResultDir.MoveWindow(&rect);
	}
	if(m_editResultDir.GetSafeHwnd())
	{
		CRect rect(3*cx/10+10,8.5*cy/10,8*cx/10,8.5*cy/10+20);
		m_editResultDir.MoveWindow(&rect);
	}
	if(	m_btnResultDir.GetSafeHwnd())
	{
		CRect rect(8*cx/10+5,8.5*cy/10,9*cx/10-5,8.5*cy/10+20);
