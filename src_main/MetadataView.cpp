...
void CMetadataView::FillMetadataView()
{
   ...
   CSoLIMDoc *pDoc = (CSoLIMDoc *)(GetDocument());
		...
		if(pDoc->m_pProjectEdit!=NULL)
	  {
		/*if(m_listctrlMetadata.GetItemCount()!=0)
		{
			m_listctrlMetadata.DeleteAllItems();
		  			...
		  			if(this->m_listctrlMetadata.GetSafeHwnd())
			{
				this->m_listctrlMetadata.DeleteAllItems();
		...
		strTemp.Format("%d",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getNumberOfRecords());
		m_listctrlMetadata.SetItemText(0,1,strTemp);*/

		strTemp.Format("Number Of Rows");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,0, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%d",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getNumberOfRows());
		m_listctrlMetadata.SetItemText(0,1,strTemp);

		strTemp.Format("Number Of Columns");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,1, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%d",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getNumberOfColumns());
		...
		strTemp.Format(pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getFileType());
		...
		strTemp.Format(pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataName());
		...
		strTemp.Format(pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getBaseFilename());
		...
		strTemp.Format(pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getGridUnits());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getXmin());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getYmin());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getCellSize());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getNeighborhood());
		...
		strTemp.Format(pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataUnits());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataMin());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataMax());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataMean());
		...
		strTemp.Format("%f",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getDataStd());
		...
		strTemp.Format("%d",pDoc->m_pProjectEdit->m_pEnvDatabase->getLayer(pApp->m_iCurrEnvLayerIndex)->m_pTheData->getFirstDataByte());
	...
	else //case base
	{
		...
		strTemp.Format("Number Of Rows");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,0, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%d",pApp->pCurLayer->m_pTheData->getNumberOfRows());
		m_listctrlMetadata.SetItemText(0,1,strTemp);

		strTemp.Format("Number Of Columns");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,1, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%d",pApp->pCurLayer->m_pTheData->getNumberOfColumns());
		m_listctrlMetadata.SetItemText(1,1,strTemp);

		strTemp.Format("File Type");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,2, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format(pApp->pCurLayer->m_pTheData->getFileType());
		m_listctrlMetadata.SetItemText(2,1,strTemp);

		strTemp.Format("Data Name");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,3, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format(pApp->pCurLayer->m_pTheData->getDataName());
		m_listctrlMetadata.SetItemText(3,1,strTemp);

		strTemp.Format("Base Filename");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,4, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format(pApp->pCurLayer->m_pTheData->getBaseFilename());
		m_listctrlMetadata.SetItemText(4,1,strTemp);

		strTemp.Format("Grid Units");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,5, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format(pApp->pCurLayer->m_pTheData->getGridUnits());
		m_listctrlMetadata.SetItemText(5,1,strTemp);

		strTemp.Format("X min");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,6, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getXmin());
		m_listctrlMetadata.SetItemText(6,1,strTemp);

		strTemp.Format("Y min");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,7, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getYmin());
		m_listctrlMetadata.SetItemText(7,1,strTemp);

		strTemp.Format("Cell Size");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,8, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getCellSize());
		m_listctrlMetadata.SetItemText(8,1,strTemp);

		strTemp.Format("Neighborhood");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,9, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getNeighborhood());
		m_listctrlMetadata.SetItemText(9,1,strTemp);

		strTemp.Format("Data Units");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,10, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format(pApp->pCurLayer->m_pTheData->getDataUnits());
		m_listctrlMetadata.SetItemText(10,1,strTemp);

		strTemp.Format("Data Min");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,11, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getDataMin());
		m_listctrlMetadata.SetItemText(11,1,strTemp);

		strTemp.Format("Data Max");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,12, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getDataMax());
		m_listctrlMetadata.SetItemText(12,1,strTemp);

		strTemp.Format("Data Mean");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,13, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getDataMean());
		m_listctrlMetadata.SetItemText(13,1,strTemp);

		strTemp.Format("Data Std");  
		m_listctrlMetadata.InsertItem(LVIF_TEXT|LVIF_STATE,14, strTemp, 0, LVIS_SELECTED,0, 0);
		strTemp.Format("%f",pApp->pCurLayer->m_pTheData->getDataStd());
		m_listctrlMetadata.SetItemText(14,1,strTemp);
...
void CMetadataView::OnInitialUpdate()
{
	...
	//	FillMetadataView(pDoc->m_pProjectCaseEdit);
