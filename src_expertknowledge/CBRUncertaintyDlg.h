...
class CBRUncertaintyDlg : public CDialog
{
	DECLARE_DYNAMIC(CBRUncertaintyDlg)

public:
	CBRUncertaintyDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CBRUncertaintyDlg();

// 对话框数据
	enum { IDD = IDD_CBR_UNCERTAIN };
