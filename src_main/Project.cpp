...
CProject::CProject(CProject& anProject)
{
	...
	m_strKnowledgeBaseFile = anProject.m_strKnowledgeBaseFile;
	...
	m_pKnowledgeBase = new CKnowledgeBase(*(anProject.m_pKnowledgeBase));
	m_pInference = new CInference(*(anProject.m_pInference));
...
CProject::~CProject(void)
{
	...
	if(m_pKnowledgeBase != NULL)
	{
		delete m_pKnowledgeBase;
		m_pKnowledgeBase = NULL;
	}
	if(m_pInference != NULL)
	{
		delete m_pInference;
		m_pInference = NULL;
	}
