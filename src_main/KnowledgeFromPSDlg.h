...
class CKnowledgeFromPSDlg : public CDialog
{
	DECLARE_DYNAMIC(CKnowledgeFromPSDlg)

public:
	CKnowledgeFromPSDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CKnowledgeFromPSDlg();

// Dialog Data
	enum { IDD = IDD_DIALOG_KNOWLEDGE_FROM_PURPOSIVE_SAMPLES };
...
public:
	...
	void SaveKnowledgeFile(CString strKBFile, CKnowledgeBase *pKnowledgeBase);
};
