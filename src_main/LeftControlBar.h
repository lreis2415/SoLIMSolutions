...
public:
	...
	HTREEITEM m_hRootRule;
	HTREEITEM m_hDatabase;
	HTREEITEM m_hKnowledge;
	HTREEITEM m_hInference;


	HTREEITEM m_hRootCase;
	HTREEITEM m_hDatabaseCase;
	HTREEITEM m_hKnowledgeCase;
	HTREEITEM m_hInferenceCase;

	HTREEITEM m_hClimate;
	HTREEITEM m_hGeology;
	HTREEITEM m_hTerrain;
	HTREEITEM m_hVegetation;
	HTREEITEM m_hOther;
...
public:	
	...
	void FillDatabaseTree(CSoLIMDoc *pDoc);
	void FillKnowledgeTree(CSoLIMDoc *pDoc);
	void FillInferenceTree(CSoLIMDoc *pDoc);

	
	void FillDatabaseCaseTree(CSoLIMDoc *pDoc);
	void FillKnowledgeCaseTree(CSoLIMDoc *pDoc);
	void FillInferenceCaseTree(CSoLIMDoc *pDoc);
...
public:
    ...
    afx_msg void OnHoverProjectTree(NMHDR* pNMHDR, LRESULT* pResult); 


	afx_msg void OnSize(UINT nType, int cx, int cy);	
	afx_msg void OnDatabaseAddlayer();
	afx_msg void OnDatalayerDelete();
	...
	afx_msg void OnKnowledgebaseCreatenew();
	afx_msg void OnKnowledgebaseLoad();
	afx_msg void OnKnowledgebaseSave();
	afx_msg void OnKnowledgebaseSaveas();

	afx_msg void OnKnowledgebaseCurrentFile();
	...
	afx_msg void OnRuleViewattachedlayer();
	...
	afx_msg void OnDatabaseCaseAddlayer();
	afx_msg void OnDatalayerCaseDelete();


   afx_msg void OnDatalayerSetvariabletype();

   bool  AddOneLayerCase(CString layerFileName, CString strCategory, HTREEITEM hCurItem);
