...
#include "WizardMinMax.h"
#include "FreehandRule.h"


class CFreehandWizard : public CDialog
{
	DECLARE_DYNAMIC(CFreehandWizard)

public:
	CFreehandWizard(CWnd* pParent = NULL);   
	virtual ~CFreehandWizard();

	enum { IDD = IDD_FREEHAND_WIZARD };
