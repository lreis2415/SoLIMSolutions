...
*/
// 3drViewerDlg.cpp : implementation file
//
...
// C3drViewerDlg dialog

IMPLEMENT_DYNAMIC(C3drViewerDlg, CDialog)
C3drViewerDlg::C3drViewerDlg(CWnd* pParent /*=NULL*/)
	: CDialog(C3drViewerDlg::IDD, pParent), m_CurFileName(_T(""))
, m_X(0)
, m_Y(0)
, m_Row(0)
, m_Col(0)
...
C3drViewerDlg::~C3drViewerDlg()
{
}

void C3drViewerDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(C3drViewerDlg, CDialog)
	...
	ON_EN_VSCROLL(IDC_FileHeaderFld, OnEnVscrollFileheaderfld)
	ON_EN_HSCROLL(IDC_FileHeaderFld, OnEnHscrollFileheaderfld)

	ON_EN_UPDATE(IDC_FileHeaderFld, OnEnUpdateFileheaderfld)
	ON_BN_CLICKED(IDOK, OnBnClickedOk)
END_MESSAGE_MAP()



void C3drViewerDlg::OnBnClickedInputfilebtn(){
...
void C3drViewerDlg::OnBnClickedUpbtn(){
	// TODO: Add your control notification handler code here
	if(m_Row>0){
		m_Row--;
		go();
...
void C3drViewerDlg::OnBnClickedDownbtn(){
	// TODO: Add your control notification handler code here
...
void C3drViewerDlg::OnBnClickedRightbtn(){
	// TODO: Add your control notification handler code here
...
void C3drViewerDlg::OnBnClickedLeftbtn(){
	// TODO: Add your control notification handler code here
	if(m_Col>0){
		m_Col--;
		go();
...
void C3drViewerDlg::go(){
	...
	GetDlgItem(IDC_FileHeaderFld)->Invalidate();
	...
	GetDlgItem(IDC_DataFld)->Invalidate();
}

// C3drViewerDlg message handlers

void C3drViewerDlg::OnEnVscrollFileheaderfld()
{
	GetDlgItem(IDC_FileHeaderFld)->Invalidate();
}

void C3drViewerDlg::OnEnHscrollFileheaderfld()
{
	GetDlgItem(IDC_FileHeaderFld)->Invalidate();
}


void C3drViewerDlg::OnEnUpdateFileheaderfld()
{
		GetDlgItem(IDC_FileHeaderFld)->Invalidate();
}

void C3drViewerDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	OnOK();
}
