...
#define UNLIKELY 0.123456

#define LARGESTFLOAT 3.40282e+38
#define SMALLESTFLOAT 1.17549e-38
...
/******************************
*	Utilities for Sample Based Inference
******************************/
...
std::string getCoreFilename(std::string& fullFileName);
void UTF8ToGB(std::string &szOut);
