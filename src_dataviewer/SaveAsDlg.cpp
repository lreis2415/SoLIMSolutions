...
IMPLEMENT_DYNAMIC(CSaveAsDlg, CDialog)
...
void CSaveAsDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_PRO_NAME, m_strDiffProName);
}
...
void CSaveAsDlg::OnBnClickedOk()
{
	UpdateData(true);
	if(m_strDiffProName == ""){	
		MessageBox("You must input a project name.");
		return;
	}
