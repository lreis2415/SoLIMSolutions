...
class CRangePage : public CDialog
{
	DECLARE_DYNAMIC(CRangePage)

public:
	CRangePage(CWnd* pParent = NULL);   // standard constructor
	virtual ~CRangePage();
...
public:
	...
	CStatic m_staticLowUnity;
	CEdit m_editLowUnity;
	CStatic m_staticHighUnity;
	CEdit m_editHighUnity;
	CStatic m_staticLowCross;
	CEdit m_editLowCross;
	CStatic m_staticHighCross;
	CEdit m_editHighCross;
...
public:
	...
	afx_msg void OnEnKillfocusEditLowUnity();
	afx_msg void OnEnKillfocusEditHighUnity();
	afx_msg void OnEnKillfocusEditLowCross();
	afx_msg void OnEnKillfocusEditHighCross();
	afx_msg void OnCbnSelchangeComboCurveType();
	afx_msg void OnBnClickedButtonUpdate();

	
	afx_msg void OnBnClickedButtonChangetofreehand();
	CComboBox m_comboAttachLayer;
