...
void CWizardChooseLayer::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CHECK_ATTACH_LAYER, m_chkAttachLayer);
}



BEGIN_MESSAGE_MAP(CWizardChooseLayer, CDialog)
	ON_BN_CLICKED(IDC_CHECK_ATTACH_LAYER, OnBnClickedCheckAttachLayer)
END_MESSAGE_MAP()
...
void CWizardChooseLayer::OnBnClickedCheckAttachLayer()
{
	m_bAttachLayer = !m_bAttachLayer;
